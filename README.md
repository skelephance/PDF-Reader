...
A premium, **local-first, fully offline book reader for PDFs** — a calm,
distraction-free way to read books and long-form documents in PDF format. It runs
as a native desktop app and an installable web PWA, all
from a single shared codebase. Built with Tauri v2 (Rust host) + TypeScript +
PDF.js.

It's a **reader, not an editor** — there's no form-filling or page editing. The
focus is reading: a clean page view, smooth zoom, reading themes, and the
annotation tools you'd want in a book (highlights, notes, bookmarks). Your library,
highlights, notes, bookmarks, and reading position stay on your device. No
accounts, no uploads, no network — by design.

- **Live web app:** https://skelephance.github.io/PDF-Reader/
- **Desktop installers:** see [Releases](https://github.com/skelephance/PDF-Reader/releases)
...
The desktop and web targets share **all** of the UI and reader code. They
